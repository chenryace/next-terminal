...
func setupRoutes() *echo.Echo {
	...
	ShareSessionApi := new(api.ShareSessionApi)
	...
	shareSessions := e.Group("/share-sessions")
	{
		shareSessions.POST("", ShareSessionApi.ShareSessionCreateEndpoint)
		shareSessions.GET("/:id", ShareSessionApi.ShareSessionGetEndpoint)
		shareSessions.GET("/paging", ShareSessionApi.ShareSessionPagingEndpoint)
		shareSessions.DELETE("/:id", ShareSessionApi.ShareSessionDeleteEndpoint)
	}
	...
	sessions := e.Group("/sessions")
	{
		...
		sessions.GET("/:id/commands/paging", mw.Admin(SessionApi.SessionCommandPagingEndpoint))
	...
	commandFilters := e.Group("/command-filters", mw.Admin)
	{
	...
	commandFilterRules := e.Group("/command-filter-rules", mw.Admin)
	{
