...
const AssetUserGroup = ({id, active}) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: ((text, record) => {
                return <Link to={`/user-groups/${record['userGroupId']}`}>{text}</Link>
            })
        },
        {
            title: '命令过滤器名称',
            ...
            hideInSearch: true,
            render: ((text, record) => {
                return <Link to={`/command-filters/${record['commandFilterId']}`}>{text}</Link>
            })
        },
        {
            title: '授权策略名称',
            ...
            hideInSearch: true,
            render: ((text, record) => {
                return <Link to={`/strategies/${record['strategyId']}`}>{text}</Link>
            })
        },
        {
            title: '授权日期',
