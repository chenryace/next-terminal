...
const CommandFilterDetail = React.lazy(() => import("./components/authorised/CommandFilterDetail"));
...
const ForbiddenCommand = React.lazy(() => import("./components/authorised/CommandFilter"));

const App = () => {

    const navigate = useNavigate();

    let infoQuery = useQuery('getUserInfo', accountApi.getUserInfo, {
        onSuccess: (data) => {
            setCurrentUser(data);
        }
    });
    ...
    return (
        <Routes>
            ...
            <Route element={<ManagerLayout/>}>
                ...
                <Route path="/command-filter" element={<ForbiddenCommand/>}/>
                <Route path="/command-filter/:commandFilterId" element={<CommandFilterDetail/>}/>
            </Route>
